...
public class MainMenuState extends BasicGameState {
	...
	public void init(GameContainer container, StateBasedGame game) throws SlickException {
    	...
    	background.addComponent(new ImageRenderComponent(new Image("/drop_assets/menu.png"))); // Bildkomponente
    	...
    	new_Game_Entity.addComponent(new ImageRenderComponent(new Image("drop_assets/entry.png")));
    	...
    	quit_Entity.addComponent(new ImageRenderComponent(new Image("drop_assets/entry.png")));
