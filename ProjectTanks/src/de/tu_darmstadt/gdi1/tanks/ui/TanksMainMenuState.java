 ...
 * werden kann.
 */
public class TanksMainMenuState extends BasicGameState {
	...
	public void init(GameContainer container, StateBasedGame game) throws SlickException {
    	...
    	Action new_Game_Action = new ChangeStateInitAction(TanksLaunch.GAMEPLAYSTATE);
