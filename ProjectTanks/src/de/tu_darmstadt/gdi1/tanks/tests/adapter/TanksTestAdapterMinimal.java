...
public class TanksTestAdapterMinimal {
	...
	TanksLaunch tanks; 						// erbt von StateBasedGame
	...
	public String getTankName(int position) {
		...
		entities = StateBasedEntityManager.getInstance().getEntitiesByState(TanksLaunch.GAMEPLAYSTATE);
