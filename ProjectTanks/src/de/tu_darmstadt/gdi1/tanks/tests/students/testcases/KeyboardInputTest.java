...
import de.tu_darmstadt.gdi1.tanks.ui.TanksLaunch;
...
public class KeyboardInputTest {
	...
	public void testNewGame() {
		...
		assertTrue(adapter.getStateBasedGame().getCurrentStateID()==TanksLaunch.MAINMENUSTATE);
		adapter.handleKeyPressN();
		assertTrue(adapter.getStateBasedGame().getCurrentStateID()==TanksLaunch.GAMEPLAYSTATE);
